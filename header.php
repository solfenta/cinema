...
<div class="block">
	<div class="wrap">
        ...
        <form action="process_search.php" id="reservation-form" method="post" onsubmit="myFunction()">
		       <fieldset>
		       	<div class="fieldt" style="padding:3px;margin-bottom:10px;">
		       	
		       		     
                                <input type="text" placeholder="Enter A Movie Name" style="height:30px;width:280px"  required id="search111" name="search">
                                
                                <input type="submit" value="Search" style="height:30px;padding-top:3px;background:chocolate;" id="button111">
    </div>       	
